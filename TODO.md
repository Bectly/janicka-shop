...
- [ ] [LEAD] Brand-specific size guide with measurements (NEW C40 — Scout research) — 52% of fashion e-commerce returns are due to poor sizing. For second-hand: return = lost sale PERMANENTLY. Build per-brand measurement database: "Zara 38 = prsa 88cm, pas 72cm, délka 95cm". Store in DB, display on product detail ABOVE fold. Crowd-source data from products as they're listed by admin. Long-term: explore AI size recommendation tools (Sizekick — selfie-based "digital twin", SMB-friendly pricing).
