...
- **Vinted CZ (UPDATED C1496)**: 75M+ members, ~EUR 8B valuation. IPO still ruled out. Vinted Pay got UK EMI licence, wallet live in 8 EU countries — **CZ still NOT included**. Collections now a **paid promotional tool**. **AI CRISIS NOW OECD-RECOGNIZED (C1496)**: OECD formally catalogued GenAI refund fraud on Vinted as an AI incident (March 2, 2026). **65% of consumers say AI has made false refund claims easier** (Ravelin data). Two scam vectors confirmed: (1) GenAI-fabricated damage photos for refund fraud, (2) AI-generated dropshipping listings (Shein/Temu disguised as second-hand). **Platform-side AI crisis persists**: CZ users on VašeStížnosti.cz report permanent bans with no human review, automated bot responses only. Support described as "GPTchat robot." Multiple CZ users threatening escalation to **ČOI** + European Consumer Centre. GDPR fine (Lithuania, €2.4M, 2024). **Trust crisis is now INTERNATIONALLY RECOGNIZED** — scammers exploit AI AND Vinted's AI punishes legitimate users.
...
- **Form fields (UPDATED C1496)**: Target **≤7-8 fields** total. Average is 14.88 — each field beyond 8 drops completion by **4-6%**. Reducing from 12 to 7-8 = **+25-35% conversion**. Target fields: email, name (single), phone, street (with autocomplete), city (auto-fill), ZIP (auto-fill), payment selection. That's 6-7 fields.
