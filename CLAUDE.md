...
## Competitive Landscape (Lead Research C19, UPDATED C34, C37, C1478, C1487)
...
- **Vinted CZ**: 75M+ members, ~EUR 8B valuation. IPO still ruled out. Vinted Pay got UK EMI licence, wallet live in 8 EU countries — **CZ still NOT included**. Collections now a **paid promotional tool** (sellers pay for homepage placement). **AI CRISIS NOW TWO-PRONGED (C1493)**: (1) **Scammer side**: GenAI-fabricated damage photos for refund fraud + AI-generated fake listings (Shein/Temu dropshipping disguised as second-hand). Vinted April 2026: "AI use is not prohibited per se" — greenlit the problem. (2) **Platform side (NEW C1493)**: Vinted's own AI moderation now BLOCKING legitimate sellers — accounts banned without reason, appeals take months, communication "practically nonexistent," customer support "too heavily AI-based." CZ users threatening escalation to **ČOI** + European Consumer Centre. Trustpilot ratings plummeting. GDPR fine (Lithuania, €2.4M, 2024). Air Bank CZ phishing warning. **Trust crisis is now STRUCTURAL and BILATERAL** — scammers exploit AI AND Vinted's AI punishes legitimate users.
...
- **Market gap**: Nobody in CZ does a visually beautiful, curated second-hand experience for women 18-35 well. **No new CZ competitors detected** (6th consecutive scan confirming gap, C1493). Odkarla.cz exists (C2C, generic). Shein/Temu gaining CZ fast-fashion share but actually pushes consumers toward second-hand as counter-narrative. **C1484 UPDATE**: EU customs duty exemption removal (July 1, 2026) adds €3/parcel duty on ALL sub-€150 imports — Shein/Temu consumer prices rising 15-50%. Domestic second-hand becomes structurally more competitive.
...
- **Conversion benchmarks (C37, UPDATED C1478, C1487, C1493)**: Fashion avg 2.9-3.3% CR. Mobile: ~1.5-2.2% vs desktop ~3.5-4.3%. On-model photography: +33% conversion. **Product video: +65% conversion.** Products with 11-30 reviews: +68% conversion. **Express checkout (Apple/Google Pay): now 30% of ALL online transactions** (up from 20% in C1478 — accelerating rapidly), +8-12% conversion uplift. Trust signals at payment: +18% completion. BNPL: +15-20% AOV. Average checkout has 14.88 fields vs 6-8 necessary. Sizing uncertainty = #1 return driver. **62% of mobile fashion sites have "mediocre or worse" PDP UX** (Baymard 2026). **Gesture-based image galleries: +108% more product views** (H&M: 2.3x more photos viewed with swipeable vs tap-based — C1493). Sticky add-to-cart CTA on mobile: **+10-25% conversion** (multiple 2026 studies). Baymard: **90% of apparel sites** fail to enable proper size/fit assessment. **57% of sites** use dropdown selectors instead of buttons for sizes (dropdowns are worse). **52% of sites** lack descriptive text/graphics for product images. Abandoned cart 3-email sequences: **6.5x revenue** vs single email ($24.9M vs $3.8M). Top performers recover **10-14%** of abandoned carts. Klaviyo: **50.5% avg open rate** for cart abandonment flows.
...
### Checkout UX Architecture (Lead Research C31, UPDATED C34, C1484)
...
- **Mobile express payments (NEW C34, REINFORCED C1484)**: Apple Pay / Google Pay buttons at VERY TOP of mobile checkout, ABOVE the accordion form. **C1484**: Mobile wallets now process **54% of ALL global online transactions.** Express payments increase mobile conversion by **12-18%** (up from +8-12% in prior estimates). This is the single most impactful checkout UX element for mobile.
...
- **Free shipping threshold**: Currently 1,500 CZK in `constants.ts`. Research: optimal threshold is 25-40% above AOV. 65%+ of orders should qualify. Evaluate after launch data — if fewer than 65% qualify, threshold is too high and may hurt conversion. Free shipping progress bar increases AOV by 22-35%.
