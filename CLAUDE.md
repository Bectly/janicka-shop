...
- **Vinted CZ (UPDATED C1505)**: 75M+ members, **EUR 8B valuation**. **EUR 813M revenue (+36% YoY)**, net profit **quadrupled** in 2025. IPO still ruled out. Vinted Pay wallet live in 8 EU countries — **CZ still NOT included**, **now live in Slovakia** (CZ rollout possible within 2026). Collections now **paid promotional tool**. **AI CRISIS DEEPENING (C1496+C1505)**: OECD formally catalogued GenAI refund fraud. **65% of consumers say AI has made false refund claims easier** (Ravelin). **C1499 TRUSTPILOT**: Vinted.cz = **2.1/5**, **76% one-star reviews**. CZ users escalating to **ČOI** + European Consumer Centre. Trust crisis DEEPENING despite record revenue — revenue growth ≠ trust recovery.
...
- **Zalando Pre-Owned (NEW C1505)**: **Now live in CZ** (14 markets total). **50% of stock sells within 24 hours.** 40%+ of Zalando orders mix new and pre-owned items. THREAT: MEDIUM — Zalando has massive brand recognition, logistics infrastructure, and customer base in CZ. However: Zalando Pre-Owned is mass-market, not curated. Their pricing competes more with Vinted than with premium curated second-hand. Our differentiator (curation, quality guarantee, Instagram-aesthetic UX) still holds. **Monitor closely** — Zalando could raise consumer expectations for second-hand UX quality.
- **Market gap**: Nobody in CZ does a visually beautiful, curated second-hand experience for women 18-35 well. **No new DEDICATED CZ second-hand women's platform** detected (**9th consecutive scan**, C1505). Zalando Pre-Owned is the closest new threat but operates as a feature within Zalando, not a standalone brand. Odkarla.cz exists (C2C, generic). **C1484 UPDATE**: EU customs duty exemption removal (July 1, 2026) adds €3/parcel duty on ALL sub-€150 imports — Shein/Temu consumer prices rising 15-50%. Domestic second-hand becomes structurally more competitive.
- **Market size (UPDATED C1505)**: Global secondhand market **~$288B in 2026** (+12.5% YoY), on track for **$393B-$486B by 2030-2031**. Online segment growing fastest. **34% of consumers' clothing budget now goes to secondhand.** 60% factor resale value when buying NEW clothes. **46% browse resale BEFORE buying new** — resale becoming default. Supply is now the constraint, not demand. Gen Z + millennials = 70%+ of market growth through 2030. **80% of Gen Z see no stigma** in second-hand, **40% of Gen Z's closet is pre-owned**, 2.5x faster adoption than other generations. **Europe second-hand clothing market (C37)**: $35.33B in 2026, projected $75.57B by 2034 (CAGR ~10%).
...
- **IMPORTANT (C31, verified C37, RE-VERIFIED C52, C1478, C1487, C1505)**: Checkout SDK still v2.0.15 (Nov 2025). **No new SDK version released as of April 4, 2026.** Direct card number entry in SDK STILL "being prepared". Card payments continue to use redirect flow or inline iframe. @comgate/checkout-js-dev package exists on npm (v2.0.4, June 2025) but is an internal build variant, NOT the promised replacement. Comgate expanded to HU, PL, BG, RO, HR, AT, DE — growing internationally but SDK development still behind.
