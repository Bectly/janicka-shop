...
## Tech Stack
- **Framework**: Next.js 16 (App Router) — upgraded from 15, currently on 16.2.2. Turbopack is default bundler. Cache Components (`"use cache"`) available. `middleware.ts` deprecated → `proxy.ts` (migration pending).
...
## Competitive Landscape (Lead Research C19, UPDATED C34, C37, C1478, C1487, C1496, C1499)
...
- **Vinted CZ (UPDATED C1499)**: 75M+ members, **EUR 8B valuation** (up from EUR 5B Oct 2024 — BlackRock, Ontario Teachers', Capital Group acquiring stakes in GBP 500M+ secondary sale; NOT an IPO but may precede one). IPO still ruled out. Vinted Pay got UK EMI licence, wallet live in 8 EU countries — **CZ still NOT included** but **now live in Slovakia** (CZ's direct neighbor — CZ rollout possible within 2026). Collections now a **paid promotional tool**. **AI CRISIS NOW OECD-RECOGNIZED (C1496)**: OECD formally catalogued GenAI refund fraud on Vinted as an AI incident (March 2, 2026). **65% of consumers say AI has made false refund claims easier** (Ravelin data). Two scam vectors confirmed: (1) GenAI-fabricated damage photos for refund fraud, (2) AI-generated dropshipping listings (Shein/Temu disguised as second-hand). **C1499 TRUSTPILOT DATA**: Vinted.cz Trustpilot score = **2.1/5**, **76% one-star reviews**. Top complaints: AI account bans without human review, copy-paste support responses, buyer protection fee perceived as ineffective scam, country-locked accounts blocking withdrawals. CZ users on VašeStížnosti.cz threatening escalation to **ČOI** + European Consumer Centre. GDPR fine (Lithuania, €2.4M, 2024). **Trust crisis DEEPENING** — all metrics trending negative.
...
- **Market gap**: Nobody in CZ does a visually beautiful, curated second-hand experience for women 18-35 well. **No new CZ competitors detected** (**8th consecutive scan** confirming gap, C1499). Odkarla.cz exists (C2C, generic). Shein/Temu gaining CZ fast-fashion share but actually pushes consumers toward second-hand as counter-narrative. **C1484 UPDATE**: EU customs duty exemption removal (July 1, 2026) adds €3/parcel duty on ALL sub-€150 imports — Shein/Temu consumer prices rising 15-50%. Domestic second-hand becomes structurally more competitive.
- **Market size (UPDATED C1478, C1487)**: Global secondhand apparel grew **13% YoY** (new apparel nearly flat). $393B by 2030. **Global secondhand market valued at $218B in 2026** (doubled from $96B in 2021 — online segment growing fastest because AI removes listing friction). **34% of consumers' clothing budget now goes to secondhand.** 60% factor resale value when buying NEW clothes. **46% browse resale BEFORE buying new** — resale becoming default. Supply is now the constraint, not demand. Gen Z + millennials = 70%+ of market growth through 2030. **Europe second-hand clothing market (C37)**: $35.33B in 2026, projected $75.57B by 2034 (CAGR ~10%).
...
- **Checkout form quick wins (NEW C1499 — Scout research)**: HTML `autocomplete` attributes reduce form abandonment by **75%**, speed completion by **35%** — zero cost, 30min implementation. **Phone number fields** cause **39% mobile abandonment** spike — make optional/conditional. **Exit intent popup** on cart page converts at **17.12%** (highest of any popup type) — perfect for second-hand unique items. **One-page checkout** (Elasticpath A/B): **+21.8% CR**. Shopify stores: 54→60%+ checkout CR after switching. **HTML form autofill** is the single highest-ROI checkout change available.
...
## CZ Payment Preferences 2026 (Updated — Lead Research C25, C1478, C1496)
- **Bank transfer: 33% (#1!)** — higher than cards. QR code on order confirmation is critical. **Instant payments (UPDATED C1499): now 43% of ALL interbank credit transfers** (2.03M/day per CNB — all-time record, up from 1.63M C1496. **99% of CZ bank clients have access**, 12 banks participating). CNB planning **bulk instant payments** (salary disbursement) for 2026. QR SPAYD auto-fills recipient+amount in banking apps.
...
### Comgate Payment Gateway — PRIMARY (Updated — Lead Research C31, verified C37, C1478, C1487)
...
- **IMPORTANT (C31, verified C37, RE-VERIFIED C52, C1478, C1487)**: Checkout SDK currently supports Apple Pay + Google Pay inline only. Direct card number entry in SDK is STILL "being prepared" by Comgate — **no change as of April 4, 2026**. Card payments continue to use redirect flow to Comgate gateway. **C1487**: Comgate expanded payment registrations to HU, PL, BG, RO, HR, AT, DE (2024-2026) — growing internationally but SDK development still behind. Comgate.eu now advertising "3 months free" promo on their international site.
...
### Packeta / Zásilkovna (Updated — Lead Research C31, C1499)
...
- **Parcel box adoption (NEW C1499)**: Surged from 56% (Jan 2025) to **72% (Dec 2025)**. 40%+ of CZ purchases delivered to pickup points. Packeta operates 9,000 Z-BOXes + ~10,000 pickup points, serving 62,000+ e-shops. **Feature Z-BOX prominently** as delivery option — customers increasingly expect it.
- **Pricing update (C1499)**: Toll surcharge CZK 1.10/kg, fuel surcharge now monthly based on EU Oil Bulletin. Minor impact on our shipping costs.
...
### Czech Legal Requirements (2026 — Updated Lead Research C31, C34, C37, C1484, C1493)
...
### SEO Strategy (Lead Research C19, Updated C25, C40, C1487)
...
- **Enhanced merchant listings**: Add `shippingDetails` + `hasMerchantReturnPolicy` for Google Shopping eligibility. **NOT YET DONE — highest priority SEO task.** **C1487**: Now a TWO-PLATFORM imperative — feeds both Google AI Overviews AND ChatGPT Shopping recommendations.
...
- **ChatGPT Shopping (UPDATED C1487)**: ChatGPT shows organic, unsponsored product recommendations ranked purely by relevance. OpenAI launched **Agentic Commerce Protocol** (with Stripe) for in-chat purchasing — but already **ending Instant Checkout** due to limited selection and stale data. Moving to retailer-specific apps. **Key**: for AI shopping, structured data quality > traffic volume. "Stores with less traffic but well-structured product cards appear more in AI recommendations than large sites with poor data." Schema.org Product/Offer/Review is MINIMUM threshold. ChatGPT drove 16% of Zara's inbound traffic mid-2025. 71% of ChatGPT citations use schema markup.
