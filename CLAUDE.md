...
- **Vinted CZ**: 75M+ members, ~EUR 8B valuation. IPO still ruled out. Vinted Pay got UK EMI licence, wallet live in 8 EU countries — **CZ still NOT included**. Collections now a **paid promotional tool** (sellers pay for homepage placement). **AI SCAM CRISIS DEEPENING (C1478, CONFIRMED C1487)**: AI-generated fake listing photos (Vintylook tool), AI-generated "damage" photos for refund scams. **C1487 UPDATE**: Scammers now routinely use ChatGPT/Gemini/Midjourney to fabricate damage photos for refund fraud. Vinted's official position (April 2026): "AI use is not prohibited per se" — effectively greenlit the problem. Multiple users report NO substantial customer support. Vinted partnered with DataDome for account fraud (bot protection) but has NO solution for AI-generated content fraud. **Trust problems structural and ACCELERATING.** GDPR fine (Lithuania, €2.4M, 2024). Air Bank CZ published phishing warning.
...
- **Market gap**: Nobody in CZ does a visually beautiful, curated second-hand experience for women 18-35 well. **No new CZ competitors detected** (4th consecutive scan confirming gap). Odkarla.cz exists (C2C, generic). Shein/Temu gaining CZ fast-fashion share but actually pushes consumers toward second-hand as counter-narrative. **C1484 UPDATE**: EU customs duty exemption removal (July 1, 2026) adds €3/parcel duty on ALL sub-€150 imports — Shein/Temu consumer prices rising 15-50%. Domestic second-hand becomes structurally more competitive.
...
### Czech Legal Requirements (2026 — Updated Lead Research C31, C34, C37, C1484)
