...
- **Market gap**: Nobody in CZ does a visually beautiful, curated second-hand experience for women 18-35 well. **No new CZ competitors detected** (7th consecutive scan confirming gap, C1496). Odkarla.cz exists (C2C, generic). Shein/Temu gaining CZ fast-fashion share but actually pushes consumers toward second-hand as counter-narrative. **C1484 UPDATE**: EU customs duty exemption removal (July 1, 2026) adds €3/parcel duty on ALL sub-€150 imports — Shein/Temu consumer prices rising 15-50%. Domestic second-hand becomes structurally more competitive.
...
- **Mobile**: 62% of Czech e-commerce is mobile. Global m-commerce: $3.4T in 2026 (22% annual growth, 3x desktop rate). Mobile = 73% of traffic but only 58% of revenue — conversion gap is THE opportunity. **Mobile cart abandonment: 85.65%** (precise 2026 figure). Fashion PWA data overwhelming: **Butcher of Blue +169% CR**, multiple fashion brands report 31-162% CR improvements.

## CZ Payment Preferences 2026 (Updated — Lead Research C25, C1478, C1496)
- **Bank transfer: 33% (#1!)** — higher than cards. QR code on order confirmation is critical. **Instant payments (UPDATED C1496): now 40% of ALL interbank credit transfers** (1.63M/day per CNB, **99% of CZ bank clients have access**). CNB planning **bulk instant payments** (salary disbursement) for 2026. QR SPAYD auto-fills recipient+amount in banking apps.
