# Janička Shop — Specs & Research

Detailní integrační specifikace, competitive research, legal requirements, feature specs.
Hlavní CLAUDE.md má tenké jádro — detail pro konkrétní task najdeš zde (grep podle topic).
