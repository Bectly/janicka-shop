  ...
  return (
    <>
      <button
        type="button"
        onClick={handleOpen}
        className="inline-flex size-9 items-center justify-center rounded-full bg-background/80 backdrop-blur-sm transition-all hover:bg-background hover:shadow-md opacity-0 translate-y-1 group-hover:opacity-100 group-hover:translate-y-0 duration-200"
              ...
              <div className="flex flex-col">
                ...
                <AddToCartButton
                  product={{
                    ...
                    colors,
                    stock: product.stock,
                    reservedByOther: product.reservedByOther,
                  }}
                />
