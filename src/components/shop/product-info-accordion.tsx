...
function AccordionItem({
  ...
  return (
    ...
    >
      <summary className="flex cursor-pointer items-center gap-4 rounded-xl px-4 py-4 text-sm font-medium text-foreground select-none transition-colors duration-150 hover:bg-muted/40 group-open:bg-muted/30 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary/40 [&::-webkit-details-marker]:hidden">
