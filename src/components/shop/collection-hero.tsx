...
export function CollectionHero({
  ...
  return (
    <div className="category-hero relative -mx-4 -mt-8 mb-10 overflow-hidden min-h-[400px] sm:min-h-[480px] lg:min-h-[560px] sm:-mx-6 lg:-mx-8">
      ...
      <div
        className="pointer-events-none absolute right-4 top-6 select-none font-heading text-[12rem] font-bold leading-none text-foreground/[0.08] sm:right-8 sm:text-[16rem] lg:right-16 lg:text-[20rem]"
        aria-hidden="true"
      >
        {title.charAt(0)}
      </div>
