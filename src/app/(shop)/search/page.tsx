                  ...
                  <div className="mt-6 flex flex-wrap justify-center gap-2">
                    {categories.map((cat) => (
                      <Link
                        ...
                        className="inline-flex min-h-[44px] items-center rounded-full border px-4 py-1.5 text-sm text-muted-foreground transition-colors duration-150 hover:border-primary hover:text-primary"
                      >
                        {cat.name}
                      </Link>
                    ))}
