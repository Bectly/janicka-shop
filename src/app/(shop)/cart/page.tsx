      ...
      <div className="flex flex-1 flex-col">
        ...
        <div className="mt-auto flex items-center justify-between pt-2">
          ...
          <button
            ...
            disabled={isRemoving}
            className="flex size-11 items-center justify-center rounded-lg text-muted-foreground transition-colors duration-150 hover:bg-muted hover:text-destructive disabled:opacity-50"
